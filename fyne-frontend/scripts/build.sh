...
./bin/fyne package -os linux -icon resources/Icon.png

echo "==> Packaging for Windows..."
if command -v x86_64-w64-mingw32-gcc >/dev/null 2>&1; then
    CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ ./bin/fyne package -os windows -icon resources/Icon.png
else
